...
void CCS_BLOCK(encrypt_hier_block)(ac_int<8,false> state_array[4][4],ac_int<128,false> &Rkey,ac_channel<int> &comp_out){
    static ac_channel<int>  data_in_state,data_in_key,mixcolumns_out,subbyte_out, shiftrows_out,  res, xorroundkey_out, round1_out,round2_out,round3_out,round4_out,round5_out,round6_out,round7_out,round8_out,round9_out;
    static ac_channel<int> key1,key2,key3,key4,key5,key6,key7,key8,key9,key10,key_to_xor,key_to_round;
...
CCS_MAIN (int argc, char* argv[]){
    ...
    ac_int<8,false> plain_text[TEST][16];//={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
    ac_int<8,false> rkey[TEST][16];//={0xe0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
    ac_int<8,false> state_array[4][4];

    ac_channel<int> ready,ready_out;
    ac_channel<int> col,xorroundkey_out,data_in_state,data_in_key,comp_out;
    ...
    for(int i = 0; i < TEST; i++){
        ...
        for(int i = 0; i < 16; i++){
            ...
            std::cout<<std::hex<<" "<<Rkey.slc<8>(i*8)<<" ";
        }
        std::cout<<std::endl;
        // Create State Array
