...
void InvSubBytes(ac_int<8,false> state_array[4][4]){
    ...
    // std::cout<<"Substituted State array"<<std::endl;
    // for(int i = 0; i < 4; i++){
    //     for(int j = 0; j < 4; j++){
    //         std::cout<<std::hex<<state_array[j][i]<<" ";
    //     }
...
void InvShiftRows(ac_int<8,false> state_array[4][4]){
    ...
    // std::cout<<"Shifted State array"<<std::endl;
    // for(int i = 0; i < 4; i++){
    //     for(int j = 0; j < 4; j++){
    //         std::cout<<std::hex<<state_array[j][i]<<" ";
    //     }
...
void decrypt(ac_int<8,false> state_array[4][4],ac_int<128,false> Rkey[11]){
...
int main() {
    ...
    for (int i=0; i<size; i++){ //iterations
        ...
        for(int i = 0; i < 4; i++){
            for(int j = 0; j < 4; j++){
                Computed_output.set_slc(120-(i*32+j*8),state_array[j][i]);
            }
        }
